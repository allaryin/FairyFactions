...
public class FRY_ModelFairyProps extends ModelBiped
{
    public FRY_ModelFairyProps()
    {
        this(0.0F);
    }

    public FRY_ModelFairyProps(float f)
    {
        this(f, 0.0F);
    }

    public FRY_ModelFairyProps(float f, float f1)
    {
        heldItemLeft = 0;
        heldItemRight = 0;
        isSneak = false;
    ...
    public void setScoutRotationAngles(float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        if (onGround > -9990F)
        {
            ...
            f6 = 1.0F - f6;
            float f8 = MathHelper.sin(f6 * (float)Math.PI);
            float f9 = MathHelper.sin(onGround * (float)Math.PI) * -(scoutHead.rotateAngleX - 0.7F) * 0.75F;
            scoutRightArm.rotateAngleX -= (double)f8 * 1.2D + (double)f9;
    ...
    public void setMedicRotationAngles(float f, float f1, float f2, float f3, float f4, float f5)
    {

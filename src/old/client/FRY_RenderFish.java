...
public class FRY_RenderFish extends Render
{
    /**
     * Actually renders the fishing line and hook
     */
    public void doRenderFishHook(FRY_EntityFishHook par1EntityFishHook, double par2, double par4, double par6, float par8, float par9)
    {
        GL11.glPushMatrix();
    ...
    {
        this.doRenderFishHook((FRY_EntityFishHook)par1Entity, par2, par4, par6, par8, par9);
    }
}

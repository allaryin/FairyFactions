...
public class FRY_EntityFishHook extends Entity
{
    ...
    public FRY_EntityFishHook(World par1World)
    {
        super(par1World);
        this.xTile = -1;
        this.yTile = -1;
    ...
    public FRY_EntityFishHook(World par1World, double par2, double par4, double par6)
    {
        this(par1World);
    ...
    public FRY_EntityFishHook(World par1World, FRY_EntityFairy fairy)
    {
        super(par1World);
        this.xTile = -1;
        this.yTile = -1;
    ...
    {
        if (ridingEntity != null && ridingEntity instanceof FRY_EntityFairy)  //Client sided only
        {
            ridingEntity.riddenByEntity = null;
            ((FRY_EntityFairy)ridingEntity).fishEntity = this;
            this.angler = (FRY_EntityFairy)ridingEntity;
        ...
        else
        {
            ...
            {
                if (this.angler == null || !this.angler.isEntityAlive() || this.angler.entityToAttack != null || this.angler.entityFear != null || !this.angler.posted() ||
                        !this.angler.tamed() || !this.angler.isSitting() || this.angler.fishEntity == null || this.getDistanceSqToEntity(this.angler) > 1024.0D)
                {
                    this.setDead();
                    return;
                }
